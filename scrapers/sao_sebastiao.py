...
def main(search_term: str):
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler("logs/scraping_sao_sebastiao.log", encoding="utf-8"),
    ...
    for noticia in noticias:
        ...
        data = clean_text(
            noticia.xpath(".//div[contains(@class,'notice-date')]/text()").getall()[1]
        )
    ...
    with open("json/dados_sao_sebastiao_bruto.json", "w", encoding="utf-8") as f:
        json.dump(resultados, f, ensure_ascii=False, indent=2)
    logging.info("Arquivo teste.json salvo com sucesso.")
    pd.DataFrame(resultados).to_excel("xlsx/dados_sao_sebastiao_bruto.xlsx")
    return "json/dados_sao_sebastiao_bruto.json"
